...
NOTEBOOKS = [
    ...
    ("03_poisoned_rag_attack.ipynb", "run", None),
    ("04_supply_chain_attack.ipynb", "run", None),
    ("05_pace_defense.ipynb", "run", None),
    ("06_benchmark_comparison.ipynb", "run", None),
    ("07_deep_agent_demo.ipynb", "run", None),
    ("08_agentdojo_benchmark.ipynb", "skip", "paid (OpenRouter); opt-in via L3 runner not pytest"),
    ("09_adaptive_budget_sweep.ipynb", "run", None),
    ("10_deepagent.ipynb", "run", None),
